...
\lightgrey Duties & Customer Relations, Basic Mathematics, Driving, Verifying Products match order and fixing any discrepancies, Customer Identity Verification.
\end{tabularx}
...
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
\gray Period & \textbf{January 2006 --- Present}\\
...
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
\gray Period & \textbf{January 2011 --- Present}\\
...
\gray Job & \textbf{Human Resources Manager, Suncorp}\\
